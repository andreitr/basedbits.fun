...
export default async function Page() {
    ...
    const burned = await getUserTokenBalance('0x000000000000000000000000000000000000dEaD');
                ...
                <div className="container max-w-screen-lg">
                    ...
                    <div className="flex flex-col gap-4 mb-8">
                        <div className="flex flex-row mb-2 items-center gap-2">
                            <div className="text-4xl mr-6">{humanizeNumber(Number(formatUnits(tokens)))} BBITS
                                Issued
                            </div>
                            <Image className="w-6" src={fire} alt="fire"/>
                            <div className="text-2xl">{humanizeNumber(Math.round(Number(formatUnits(burned))))} Burned
