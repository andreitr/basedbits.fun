...
export const MintButton = ({token, revalidate}: Props) => {
    ...
    const socialDisplay = () => {
        ...
        const encodedText = encodeURIComponent(`I just minted ${token.name} and entered the mint raffle!`);
            ...
            <div
                ...
                <div className="flex flex-col justify-end gap-5">
                    <div className="flex flex-row justify-between items-start">
                        <div>Minted {token.name} and entered the raffle. Spread the word 🙏</div>
    ...
    useEffect(() => {
        if (isSuccess && !refresh) {
            toast.success(`Minted ${token.name} and entered the raffle!`, {duration: 10000});
            socialDisplay();
            revalidate();
            setRefresh(true);
        }
