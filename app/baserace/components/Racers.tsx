...
export const Racers = ({ count, eliminated }: Props) => {
    const [racers, setRacers] = useState(Array.from({ length: count }).map((_, index) => index).reverse());
    ...
    return (
        <div>
            <div onClick={handleShuffle} className="cursor-pointer mb-4">MOVE LAST TO FIRST</div>
