  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <div className="flex justify-center items-center w-full">
        <div className="container max-w-screen-lg mt-5 mb-10 p-2 md:mt-16 md:mb-24 md:p-0">
          <div className="text-2xl md:text-5xl text-[#363E36]">Based Bits</div>
          <div className="mt-2 md:mt-4  text-[#677467]">
          ...
          <div className="flex flex-col md:flex-row justify-start gap-3 mt-8 md:gap-16 md:mt-16 text-[#677467]">
            <div>
